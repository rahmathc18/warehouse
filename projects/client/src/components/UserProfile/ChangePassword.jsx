...
const changePasswordSchema = Yup.object().shape({
    ...
    newPasswordConfirmation: Yup.string()
        ...
        .min(8, 'Minimum 8 characters for password.')
        .oneOf([Yup.ref('newPassword')], "Password does'nt match!"),
});
        ...
        try {
            const response = await axios.patch(
                `${baseApi}/users/password-update/${user.id}`,
                {
                    ...
                    newPasswordConfirmation: formik.values.newPasswordConfirmation,
                },
                {
                    headers: {
                ...
                <ModalContent>
                    ...
                    <ModalBody>
                        <form onSubmit={formik.handleSubmit}>
                            <FormControl isRequired id="oldPassword" mb={4} isInvalid={!!formik.errors.oldPassword}>
                                ...
                                <InputGroup>
                                    ...
                                    value={formik.values.oldPassword}
                                     />
                                    <InputRightElement>
                                        <Button onClick={() => setViewOld(prev => !prev)}>
                                            {viewOld ? (<ViewIcon />) : (<ViewOffIcon />)}
                                        </Button>
                                    </InputRightElement>
                                </InputGroup>
                            ...
                            <FormControl isRequired id="newPassword" mb={4} isInvalid={!!formik.errors.oldPassword}>
                                ...
                                <InputGroup>
                                    ...
                                    />
                                    <InputRightElement>
                                        <Button onClick={() => setViewNew(prev => !prev)}>
                                            {viewNew ? (<ViewIcon />) : (<ViewOffIcon />)}
                                        </Button>
                                    </InputRightElement>
                                </InputGroup>
                            ...
                            <FormControl isRequired id="newPasswordConfirmation" mb={4} isInvalid={!!formik.errors.newPasswordConfirmation}>
                                ...
                                <InputGroup>
                                    ...
                                    />
                                    <InputRightElement>
                                        <Button onClick={() => setViewConfirm(prev => !prev)}>
                                            {viewConfirm ? (<ViewIcon />) : (<ViewOffIcon />)}
                                        </Button>
                                    </InputRightElement>
                                </InputGroup>
                                {formik.errors.newPasswordConfirmation && formik.touched.newPasswordConfirmation ? (
                                    <FormErrorMessage>{formik.errors.newPasswordConfirmation}</FormErrorMessage>
                                ) : null}
                            </FormControl>
